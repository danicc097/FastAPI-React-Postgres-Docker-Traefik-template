...
import { icon as keyboard_shortcut } from '@elastic/eui/es/components/icon/assets/keyboard_shortcut'
...
import { icon as text } from '@elastic/eui/es/components/icon/assets/text'
