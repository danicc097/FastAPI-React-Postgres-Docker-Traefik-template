...
CREATE INDEX ix_global_notifications_created_at ON "global_notifications" USING btree ("created_at");

CREATE INDEX ix_global_notifications_receiver_role ON "global_notifications" USING btree ("receiver_role");

CREATE INDEX ix_global_notifications_updated_at ON "global_notifications" USING btree ("updated_at");

CREATE UNIQUE INDEX ix_users_email ON "users" USING btree ("email");

CREATE INDEX ix_users_last_notification_at ON "users" USING btree ("last_notification_at");

CREATE INDEX ix_users_role ON "users" USING btree ("role");

CREATE UNIQUE INDEX ix_users_username ON "users" USING btree ("username");

CREATE INDEX notifications_created_at_receiver_role ON "global_notifications" USING btree ("created_at", "receiver_role");
...
ALTER TABLE ONLY "global_notifications"
  ADD CONSTRAINT global_notifications_sender_fkey FOREIGN KEY (sender) REFERENCES users (email) ON DELETE CASCADE;
