...
--
CREATE SEQUENCE public.global_notifications_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.pwd_reset_req_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER COLUMN id
SET DEFAULT nextval('public.global_notifications_id_seq'::regclass);
--
...
ALTER COLUMN id
SET DEFAULT nextval('public.pwd_reset_req_id_seq'::regclass);
--
...
--
CREATE TRIGGER update_user_request_modtime BEFORE
UPDATE ON public.pwd_reset_req FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column ();
--
