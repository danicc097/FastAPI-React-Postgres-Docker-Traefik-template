...
class TestProfilesRoutes:
    ...
    async def test_routes_exist(self, app: FastAPI, client: AsyncClient, test_user: UserPublic) -> None:
        # Get profile by username
        res = await client.get(app.url_path_for("profiles:get-profile-by-username", username=test_user.username))  # type: ignore
